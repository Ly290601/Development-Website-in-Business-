...
@Component({
  selector: 'app-product-other',
  templateUrl: './product-other.component.html',
  styleUrls: ['./product-other.component.css']
})
export class ProductOtherComponent implements OnInit {
  ...
  getProductCategory(){
    this._service.getListProductByCategory3().subscribe({
      next: (data) => {
        this.productList = data,
          console.log(this.productList)
      },
