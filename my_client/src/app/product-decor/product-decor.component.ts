...
@Component({
  selector: 'app-product-decor',
  templateUrl: './product-decor.component.html',
  styleUrls: ['./product-decor.component.css']
})
export class ProductDecorComponent implements OnInit {
  ...
  getProductCategory(){
    this._service.getListProductByCategory1().subscribe({
      next: (data) => {
        this.productList = data,
          console.log(this.productList)
      },
